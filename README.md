...
### 😊 Halk Mutluluğu Sistemi
- Aldığınız her karar halkın mutluluğunu doğrudan etkiler
- Mutluluk %0-100 arasında dinamik olarak değişir
- Renkli gösterge çubuğu ile anlık takip
- Düşük mutluluk = Halk memnuniyetsiz, yüksek mutluluk = Başarılı yönetim

### 👔 Belediye Başkanı Desteği
- Kararlarınıza göre halkın size olan desteği değişir
- %70+ destek = Seçimi kazanma şansınız yüksek
- %50-70 = Dengede, çekişmeli seçim
- %30-50 = Destek düşük, güven kazanmalısınız
- %30- = Seçimi kaybetme riski çok yüksek

### 🎲 Dinamik Senaryo Sistemi
- **Her oyunda farklı senaryolar!** Artık aynı sorular tekrar etmiyor
- **30+ farklı senaryo** havuzundan rastgele seçim
- Ulaşım: 3 farklı senaryo (bisiklet yolu, elektrikli otobüs, trafik krizi vb.)
- Çevre: 3 farklı senaryo (ağaç kesimi, çöp krizi, yeşil alan vb.)
- Enerji: 3 farklı senaryo (nükleer enerji, güneş paneli, fosil yakıt vb.)
- Sosyal: 3 farklı senaryo (gençlik merkezi, hayvan barınağı, ücretsiz ulaşım vb.)
- Senaryolar akıllı sistem ile tekrar etmez

### ⚡ Rastgele Olaylar (Geliştirildi)
- Oyun sırasında beklenmedik olaylar (%50 şans)
- **13+ farklı olay türü**: Deprem, sel, protesto, festival, hava kirliliği, yolsuzluk iddiası vb.
- Her olay için 3 farklı seçenek
- Olaylar mutluluk ve desteği doğrudan etkiler
- Kriz yönetimi becerinizi test eder

### 📊 Gelişmiş Göstergeler
- Halk mutluluğu çubuğu (renkli: yeşil/sarı/kırmızı)
- Başkan desteği çubuğu (renkli: yeşil/sarı/kırmızı)
- Anlık geri bildirim sistemi
- Her turda güncel durum özeti

### 💬 Halkın Yorumları
- Her karardan sonra rastgele halk yorumları
- Mutluluğa göre değişen tepkiler
- Final raporunda detaylı halk yorumları
- Gerçekçi vatandaş geri bildirimleri

## ✨ Özellikler

### 🎮 Oyun Mekanikleri
- **3 Karar Turu**: Ulaşım, Çevre, Enerji (dinamik senaryolar)
- **8 Gösterge**: Hava kalitesi, trafik, yeşil alan, karbon emisyonu, yaşam kalitesi, ekonomi, mutluluk, destek
- **Dinamik Final Senaryoları**: Mutluluk ve destek oranına göre değişen sonuçlar
